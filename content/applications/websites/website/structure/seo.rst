...
.. note::
   ...
   - All :doc:`themes <../web_design/themes>` provided rely on the CSS Framework `Bootstrap
...
- :guilabel:`Description` tags summarize the webpage's content, often displayed in search engine
  ...
  Update the description tag of the webpage, or keep it empty to use the default value based on
  the page’s content.
...
default. With a third-party theme, it may provide images that are not compressed efficiently.
...
.. tip::
   ...
   Settings` in the :guilabel:`SEO` section and enable :guilabel:`Default Social Share Image`.
...
By doing this, search engines reindex the site and maintain the visibility in search results.
