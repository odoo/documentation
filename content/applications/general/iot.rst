...
An IoT box subscription is required :ref:`for production use of IoT systems
<iot/https_certificate_iot>`. If you have issues related to your subscription, contact the
database's account manager or Odoo partner for assistance.

.. tip::
   If the subscription is linked to a `<https://www.odoo.com>`_ portal user, check the information
   on the portal's subscription page.
