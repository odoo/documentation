...
<ecommerce/products/additional_features/product-comparison>` tool, :ref:`wishlists
...
.. tabs::
   ...
   .. tab:: Catalog page
      ...
      the :guilabel:`Style` tab, and click the :icon:`fa-paint-brush` icon next to
...
.. tabs::
   ...
   .. tab:: Catalog page
      ...
      :ref:`shop page <ecommerce/catalog/product-listing>`, open the website editor, go to
      :guilabel:`Style`, and click the :icon:`fa-paint-brush` icon next to
   ...
   .. tab:: Header
      ...
      enbaled, the wishlist icon only appears when an item has been added to the wishlist. The
...
Click the :icon:`fa-paint-brush` icon next to :guilabel:`Products Design` to access more
