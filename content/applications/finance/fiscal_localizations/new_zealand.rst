...
#. To configure the tax, go to :menuselection:`Accounting--> Configuration --> Taxes`. Create the
   necessary taxes for the Employment Hero payslip entries.
   :menuselection:`Businesss--> Expense Categories --> Add`

   .. image:: new_zealand/payroll_expense_categories.png
      :alt: Expense Categories.

   .. image:: new_zealand/add_expense_categories.png
      :alt: Add Expense Category.

   Fill in the tax code from **Employment Hero** in the Matching Employment Hero Tax field.

   .. image:: new_zealand/odoo_matching_employment_hero_tax.png
      :alt: Matching Employment Hero Tax.

   .. image:: new_zealand/employment_hero_tax_code.png
      :alt: Employment Hero Tax Code.


   - :guilabel:`Name`: Name of Expense
   - :guilabel:`External ID`: External ID of Expense in Odoo (optional)
   - :guilabel:`Tax Code`: Matching Tax Code in Odoo
   - :guilabel:`Tax Rate`: % of tax (inclusive)
...
:menuselection:`Business--> Payroll Settings--> Chart of Accounts-->Default Accounts`.

.. image:: new_zealand/employment_hero_payroll_settings.png
   :alt: Employment Hero Payroll Settings.

.. image:: new_zealand/employment_hero_default_accounts.png
   :alt: Employment Hero Default Accounts.

For the API to work, you need to create the same accounts as the default accounts of your
Employment Hero business (**same name and same code**) in Odoo. You also need to choose the
correct account types in Odoo to generate accurate financial reports.

.. image:: new_zealand/COA_Odoo.png
   :alt: COA in Odoo.

.. image:: new_zealand/COA_employment_hero.png
   :alt: COA in Employment Hero.
