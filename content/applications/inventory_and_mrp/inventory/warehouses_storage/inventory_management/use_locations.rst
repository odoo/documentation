...
The :guilabel:`Last Inventory` field displays the date the last inventory count at this
location occurred. When scheduled inventory counts are enabled, the :guilabel:`Next Expected` field
displays the date of the next inventory count.
...
Next, click the :guilabel:`Products` smart button to get a list of all products at the
location.
