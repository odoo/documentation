...
The creditor generally uploads a fixed-format text file with the list of payments to the bank's web
portal.
...
- Fill out the required :guilabel:`SIA Code` on the Company settings form.
...
Accept RiBa for your invoices
-----------------------------

Payments of type :abbr:`Ri.Ba. (Ricevuta Bancaria)` can be registered in the invoices list
(:menuselection:`Accounting --> Customers --> Invoices`).

.. warning::
   Make sure that your invoice involves a Partner that has a bank account with an Italian IBAN.

   .. image:: italy/partner-account.png
      :alt: Partner's Bank Account
