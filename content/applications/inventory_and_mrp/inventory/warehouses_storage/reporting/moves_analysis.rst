...
.. _inventory/warehouses_storage/moves-analysis-measures:

Measures
========

The following :ref:`measures <reporting/choosing-measures>` can be selected to quantify the data in
the :ref:`pivot <inventory/warehouses_storage/moves-analysis-pivot-view>` and :ref:`graph
<inventory/warehouses_storage/moves-analysis-graph-view>` views:
...
<inventory/warehouses_storage/moves-analysis-measures>` in a table with two axes, which makes it
most suitable for comparing quantities and values by time period, product, category, or location.
...
measure to plot from the :ref:`Measures <inventory/warehouses_storage/moves-analysis-measures>`
drop-down in the top-left corner, then choose one of the chart types next to it.
