...
After posting the Journal Entry, click on "Mark as Closing Entry for the Fiscal Year". This step
is important because it is linked to the Trial Balance report. If this Journal Entry is not mark
as a Closing Entry, the Trial Balance won't be correct.
