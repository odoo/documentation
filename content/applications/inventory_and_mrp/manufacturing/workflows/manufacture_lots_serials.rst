...
--> Configuration --> Settings`, scrolling down to the :guilabel:`Traceability` section, and ticking
...
:guilabel:`Track Inventory` checkbox is ticked on the product's form. Since lot and serial number
functionality is enabled, a drop-down menu appears next to the ticked checkbox.

Click on the :guilabel:`Track Inventory` drop-down menu. Select :guilabel:`By Lots` to track the
product using lot numbers, or :guilabel:`By Unique Serial Number` to track the product using serial
numbers.
