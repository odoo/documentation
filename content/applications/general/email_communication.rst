...
<email-inbound-custom-domain-redirections>` or :ref:`using a subdomain
<email-inbound-custom-domain-dns>`).

.. seealso::
  :doc:`Manage inbound messages <email_communication/email_servers_inbound>`
