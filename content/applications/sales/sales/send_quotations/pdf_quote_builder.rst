...
.. note::
   ...
   Configuration --> Quotation Templates`, select a template and directly :guilabel:`Add` or
   :guilabel:`Upload` a PDF to it in the :guilabel:`Quote Builder` tab.
...
On a :guilabel:`Sales Order`, in the :guilabel:`Quote Builder` tab, select additional documents to
