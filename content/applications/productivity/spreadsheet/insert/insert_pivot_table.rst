...
<spreadsheet/insert-pivot-table/dynamic-convert>`.
...
.. tip::
   ...
   function used to retrieve the quantity invoiced for the salesperson :guilabel:`Laurie Poiret`
   for :guilabel:`Q2 2025`.
...
.. tip::
   ...
   The pivot table structure can also be controlled via the :ref:`pivot table properties
   <spreadsheet/pivot-tables/properties>`, in the :ref:`Design
