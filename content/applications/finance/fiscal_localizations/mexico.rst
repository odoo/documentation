...
Make sure the :guilabel:`EDI for Mexico (Advanced Features)` (`l10n_mx_edi_extended`) module is 
installed to complete the :guilabel:`Address Issued` field on the sales journal. This ensures that 
all invoices from that sales journal, as well as :ref:`global invoices <l10n/mx/global-invoice>`, 
