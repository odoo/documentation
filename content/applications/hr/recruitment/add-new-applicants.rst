...
- :guilabel:`Expected`: Enter the amount the applicant is requesting in this field. The number
  ...
  company.
- :guilabel:`Other Benefits`: If any benefits are requested by the applicant, enter then in the
...
- :guilabel:`Medium`: Using the drop-down menu, specify how the job listing was found. The
  ...
  :guilabel:`SMS`, :guilabel:`Television`, :guilabel:`Website`, :guilabel:`X` (formerly known as
  "Twitter"), or :guilabel:`[Push Notifications] (website name)`. To add a new :guilabel:`Medium`,
  type in the medium, then click :guilabel:`Create "(new medium)"`.
