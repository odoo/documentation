...
Select the payment method by going to the :ref:`POS' settings <pos/configuration/settings>` and
adding it to the payment method under the :guilabel:`Payment Methods` field of the
