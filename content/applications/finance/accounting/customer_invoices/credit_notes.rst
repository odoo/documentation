...
A **credit/debit note**, or **credit/debit memo**, is a document sent to a customer to inform them
...
related bill to record a debit note in the :guilabel:`Bills` list view. Click :icon:`fa-cog`
:guilabel:`Actions` and select :guilabel:`Create Debit Note`.
