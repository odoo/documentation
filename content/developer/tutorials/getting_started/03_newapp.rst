...
.. exercise:: Create the required addon files.
    ...
    The ``__manifest__.py`` file should only define our modules' names and dependencies.
...
tada, your module appears! Did it not appear? Maybe try removing the default 'Apps' filter ;-)
