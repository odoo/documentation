...
.. note::
   ...
   - Printers might take up to five minutes to appear in :menuselection:`IoT --> Devices`.
...
#. Set the :guilabel:`Administration` dropdown menu to :guilabel:`Modify Printer`.
...
.. seealso::
   `Windows generic driver for ZPL printers
