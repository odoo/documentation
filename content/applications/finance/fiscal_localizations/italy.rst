...
.. warning::
   Fiscal printers are distinct from :doc:`ePOS printers </applications/sales/point_of_sale/configuration/epos_printers>`.
   The IP address for a fiscal printer should not be entered in the ePOS IP address settings.
