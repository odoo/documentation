...
- :ref:`localization/united-kingdom/taxes`: pre-configured tax rates, including standard VAT,
...
**is this flow still accurate for all users, even landlords/sole traders?**
If you have no yet connected your database to HMRC, follow these steps to do so:

#. Go to :menuselection:`Accounting --> Reporting --> Tax report`.
#. Click the :icon:`fa-cog` (:guilabel:`gear`) icon, then click :guilabel:`Connect to HMRC`.
#. Enter your company information on the HMRC platform.
...
To generate a cumulative report, follow these steps:
...
#. Click the :guilabel:`Period Report` button to open the period report.

.. tabs::

   .. group-tab:: Sole traders

      4. In the :guilabel:`Business Income` section, click the :icon:`fa-pencil`
      ...
      #. In the :guilabel:`Business Expenses` section, click the :icon:`fa-pencil`
         ...
         .. note::
            Once a cumulative report is submitted, future reports will force the same option that
            was previously submitted on the :guilabel:`Consolidated expenses request` line.

   .. group-tab:: UK landlords

      4. In the :guilabel:`Income` section, click the :icon:`fa-pencil` (:guilabel:`pencil`) icon on
   ...
   .. group-tab:: Foreign landlords
      ...
      4. Click :guilabel:`Properties` to create new and add existing :ref:`properties
         <localization/united-kingdom/buildings>` to the report.
      #. Click :guilabel:`Property Incomes and Expenses` to create and add :ref:`property incomes
         and expenses <localization/united-kingdom/property-income>` to the report.
...
#. Click the :guilabel:`Validate` button to ensure there are no errors with the format of the
   ...
   .. note::
      When using the :guilabel:`Period Report`, it is important to only enter the income and expense
      values for the period of the report. These values are then aggregated with the values of the
      other periods in the cumulative report. To review the values of the cumulative report,
      navigate to the cumulative report's overview and click the :guilabel:`Cumulative Report`
      button to open the cumulative report itself.
...
To generate an annual report, follow these steps:
...
#. Click the :guilabel:`Annual Report` button to open the annual report itself.

.. tabs::

   .. group-tab:: Sole traders

      4. In the :guilabel:`Adjustments` section, click the :icon:`fa-pencil` (:guilabel:`pencil`)
   ...
   .. group-tab:: UK landlords
      ...
      #. In the :guilabel:`Allowances` section, if property allowances have been requested, click
         ...
         property allowance has been requested, leave the line set to :guilabel:`No`. Either way,
   ...
   .. group-tab:: Foreign landlords
      ...
      4. Click :guilabel:`Property Adjustments and Allowances` to create and add :ref:`property
         adjustments and allowances <localization/united-kingdom/property-adjust>` to the
         report.
      #. If a non-property allowance has been created, that allowance can be allocated to a specific
         building:
      #. **to check process - maybe add subpoints here**

Then, submit the annual report:

#. Click :guilabel:`Tax Return` in the breadcrumbs to return to the annual report's overview.
#. Click the :guilabel:`Validate` button to ensure there are no errors with the format of the report
   and to generate a PDF of the report in the chatter.
...
To generate a BSAS report, follow these steps:
...
#. Click the :guilabel:`BSAS Report` button to open the BSAS report itself.

.. tabs::

   .. group-tab:: Sole traders

      6. If necessary, make any of the following edits to the BSAS report:
   ...
   .. group-tab:: UK landlords
      ...
      6. If necessary, make any of the following edits to the BSAS report:
         ...
         #. In the :guilabel:`Business Income` section, click the :icon:`fa-pencil`
            (:guilabel:`pencil`) icon on any line whose value needs to be updated, enter the
            appropriate value, and click :guilabel:`Post`.
         #. In the :guilabel:`Expenses` section, add the expenses to report, including the
            :guilabel:`Residential financial cost` and either consolidated or non-consolidated
            expenses:
   ...
   .. group-tab:: Foreign landlords
      ...
      6. If necessary, make any of the following edits to the BSAS report:
         ...
         #. Click :guilabel:`Properties` to create new and edit existing :ref:`properties
            <localization/united-kingdom/properties>` on the report.
         #. Click :guilabel:`Property Incomes and Expenses` to create new and edit existing
            :ref:`property incomes and expenses <localization/united-kingdom/property-income>` on
            the report.

.. note::
   If a line's value is updated after fetching the report from HMRC, an
   :icon:`fa-exclamation-circle` (:guilabel:`exclamation point`) icon appears on the line to
   highlight the discrepancy between the report and the data from HMRC.

Then, submit the BSAS report.
...
A final declarations is automatically created for the current tax year. To review the final
declaration, follow these steps:

#. Navigate to :menuselection:`Accounting --> Accounting --> Tax Returns` and open the final
   declaration for the current tax year.
#. Click :guilabel:`Validate` to prepare the report to be populated with data from HMRC and to
   generate a PDF of the report in the chatter.
...
**how to actually add buildings to the reports? "accessed" or "created" since you can't edit?**
Buildings can be accessed through the properties model on the following reports:

- :guilabel:`Foreign Property - Cumulative (GB)`
- :guilabel:`Foreign Property - Annual (GB)`
- :guilabel:`Foreign Property - BSAS (GB)`

.. note::
   - Buildings can be added to properties.
   - Foreign must link all of their buildings to their respective properties.

.. _localization/united-kingdom/building-allow:

Building allowance
******************

Building allowances can be accessed through the following reports:

- :guilabel:`Sole Trader - Annual (GB)`
- :guilabel:`UK Property  - Annual (GB)`
- :guilabel:`Foreign Property - Annual (GB)`

**add other reports**

The :guilabel:`Building Allowance` list view displays all the allowances related to buildings that
should be included in the associated annual report.

From the :guilabel:`Building Allowance` list view, to create a new building allowance, click the
:guilabel:`New` button. In the form view, enter the details of the allowance:

#. Confirm that the :guilabel:`Company` is correct. This field is automatically populated with the
   active company when the new record is created.
#. Select the :guilabel:`Building` that the allowance is related to.
#. Enter the :guilabel:`Amount` of the allowance.
#. Confirm that the :guilabel:`Date` is correct. This field is automatically populated with the last
   day of the period of the current return.
#. If the building allowance is an enhanced allowance, tick the :guilabel:`Enhanced` checkbox.
...
Properties can be accessed through the following reports:
...
If properties have been submitted to HMRC in the past, click the :guilabel:`Fetch from HMRC` button
to automatically create them in Odoo. Otherwise, click the :guilabel:`New` button to create a new
property and enter a :guilabel:`Name`. Verify the :guilabel:`Company`, select the
:guilabel:`Country`, and add the :ref:`building(s) <localization/united-kingdom/buildings>` related
to this property.

To exclude the property from a tax submission, add the appropriate :guilabel:`End Date` and
:guilabel:`End Reason`.

After creating a new property or making any changes to an existing one, click :guilabel:`Register to
HMRC`.

.. _localization/united-kingdom/property-income:

Property income and expenses
****************************

**guilabel name might change**

The :guilabel:`Incomes and Expenses Property` list view displays all the incomes and expenses
related to properties that should be included in the associated cumulative or BSAS report. Each
property (except those with a valid end date) should have at least one line detailing its income and
expenses.

From the :guilabel:`Incomes and Expenses Property` list view, to create a new record of income and
expenses related to a property, click the :guilabel:`New` button. In the form view, enter the
details of the income and expense:

#. Confirm that the :guilabel:`Company` is correct. This field is automatically populated with the
   active company when the new record is created.
#. Select the :guilabel:`Property` that the income and expenses are related to.
#. Confirm that the :guilabel:`Date` is correct. This field is automatically populated with the last
   day of the period of the current return.
#. Optionally, tick the :guilabel:`Use consolidated expenses`.
#. In the :guilabel:`Income` section, complete the relevant fields related to this property's
   income.
#. In the :guilabel:`Expenses` section, complete the relevant fields related to this property's
   expenses.

.. _localization/united-kingdom/property-adjust:

Property adjustments and allowances
***********************************

The :guilabel:`Property Adjustments and Allowances` list view displays all the adjustments and
allowances related to properties that should be included in the associated annual report.

From the :guilabel:`Property Adjustments and Allowances` list view, to create a new record of
adjustments and allowances related to a property click the :guilabel:`New` button. In the form view,
enter the details of the adjustments and allowances:

#. Confirm that the :guilabel:`Company` is correct. This field is automatically populated with the
   active company when the new record is created.
#. Select the :guilabel:`Property` that the adjustments and allowances are related to.
#. Confirm that the :guilabel:`Date` is correct. This field is automatically populated with the last
   day of the period of the current return.
#. Select the :guilabel:`Type of allowance`.
#. Complete the :guilabel:`Adjustments` and :guilabel:`Allowances` sections.
