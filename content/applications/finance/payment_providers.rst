...
.. list-table::
   ...
   * - :doc:`DPO Pay <payment_providers/dpo>`
     ...
     -
     -
   * - :doc:`ECPay <payment_providers/ecpay>`
     - The provider's website
     -
     -
     -
...
Some payment methods do not rely on an external payment provider. These methods are installed and
configured as payment providers in Odoo, and include the following:
