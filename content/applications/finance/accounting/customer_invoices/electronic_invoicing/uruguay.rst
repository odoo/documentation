...
meet Uruguay’s regulatory requirements and fully compatible with the guidelines established by the
`Dirección General Impositiva (DGI) <https://www.gub.uy/direccion-general-impositiva/>`_.
...
- **Supported formats**: Odoo supports the :abbr:`CFE (Comprobante Fiscal Electrónico)` format in
  ...
  automated submission, validation and issuance process through the :abbr:`DGI (Dirección General
...
.. admonition:: Disclaimer
   ...
   consulting with a tax advisor or legal professional familiar with Uruguay’s e-invoicing laws to
