...
<howtos/website_themes/building_blocks/custom>` and to add them into a dedicated category.

.. _howtos/website_themes/building_blocks/file_structure:
...
.. _howtos/website_themes/building_blocks/layout:
...
.. _howtos/website_themes/building_blocks/layout/wrapper:
...
.. tip::
   ...
   2. **Code everything directly:** But beware of compatibility with the Website Builder. It
...
.. _howtos/website_themes/building_blocks/layout/elements:
...
.. _howtos/website_themes/building_blocks/layout/elements/sizing:
...
.. _howtos/website_themes/building_blocks/layout/elements/colors:
...
.. _howtos/website_themes/building_blocks/layout/elements/features:
...
.. _howtos/website_themes/building_blocks/layout/grid:
...
.. _howtos/website_themes/building_blocks/compatibility:
...
.. _howtos/website_themes/building_blocks/custom:

Custom snippet
==============

To create a custom snippet, create first the snippet template. Then, add
the it to the list and make it available via Website Builder.

.. _howtos/website_themes/building_blocks/custom/template:
...
.. _howtos/website_themes/building_blocks/custom/options:
...
.. seealso::
   - `Standard snippet options <https://github.com/odoo/odoo/blob/16.0/addons/website/views/snippets/snippets.xml>`_

.. _howtos/website_themes/building_blocks/custom/options/template:
...
.. _howtos/website_themes/building_blocks/custom/options/binding:
...
.. _howtos/website_themes/building_blocks/custom/options/binding/data_selector:
...
.. _howtos/website_themes/building_blocks/custom/options/binding/data_target:
...
.. _howtos/website_themes/building_blocks/custom/options/binding/data_exclude:
...
.. _howtos/website_themes/building_blocks/custom/options/binding/data_drop_in:
...
.. _howtos/website_themes/building_blocks/custom/options/binding/data_drop_near:
...
.. _howtos/website_themes/building_blocks/custom/options/binding/data_js:
...
.. _howtos/website_themes/building_blocks/custom/options/layout_fields:

Layout & fields
~~~~~~~~~~~~~~~

.. _howtos/website_themes/building_blocks/custom/options/layout_fields/we_title:
...
.. _howtos/website_themes/building_blocks/custom/options/layout_fields/we_row:
...
.. _howtos/website_themes/building_blocks/custom/options/layout_fields/we_button:
...
.. _howtos/website_themes/building_blocks/custom/options/layout_fields/we_select:
...
.. _howtos/website_themes/building_blocks/custom/options/layout_fields/we_button_group:
...
.. _howtos/website_themes/building_blocks/custom/options/layout_fields/we_checkbox:
...
.. _howtos/website_themes/building_blocks/custom/options/layout_fields/we_range:
...
.. _howtos/website_themes/building_blocks/custom/options/layout_fields/we_input:
...
.. _howtos/website_themes/building_blocks/custom/options/layout_fields/we_colorpicker:
...
.. _howtos/website_themes/building_blocks/custom/options/methods:
...
.. _howtos/website_themes/building_blocks/custom/options/methods/builtin:

Built-in methods
****************

.. _howtos/website_themes/building_blocks/custom/options/methods/builtin/selection:
...
.. _howtos/website_themes/building_blocks/custom/options/methods/builtin/events:
...
.. seealso::
   - `Web Editor - JavaScript methods related to snippet options on GitHub
     <{GITHUB_PATH}/addons/web_editor/static/src/js/editor/snippets.options.js#L3247>`_
   - `XML templates of the different snippets
     <{GITHUB_PATH}/addons/website/views/snippets/snippets.xml>`_

.. _howtos/website_themes/building_blocks/custom/options/methods/custom:
...
.. _howtos/website_themes/building_blocks/custom/dynamic:
...
.. _howtos/website_themes/building_blocks/custom/dynamic/call:
...
.. _howtos/website_themes/building_blocks/custom/dynamic/examples:
