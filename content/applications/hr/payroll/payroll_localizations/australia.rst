...
.. list-table::
   ...
   * - :guilabel:`Australia - Payroll with API`
     ...
     - - l10n_au_hr_payroll_account
       ...
       - auth_timeout
     - NEED INFO
   * - :guilabel:`Australia - Payroll with OAuth2`
...
When the **l10n_us_hr_payroll** module is :ref:`installed <payroll/au_apps>`, a new
:guilabel:`Salary Structure` gets installed, :guilabel:`Australia: Regular Pay`. This structure
includes one :guilabel:`Structure Type`, :guilabel:`Australia: Regular Pay`.
...
.. image:: united_states/structure-types.png
   :alt: The Australia salary structure in the salary structures list.
...
States: Employee` group to reveal the :guilabel:`Australia: Regular Pay` structure type. Click
:guilabel:`Australia: Regular Pay` to view the detailed salary rules.
...
taxes, and insurance. The *logic* behind the :guilabel:`Australia: Regular Pay` rules is as
follows:
...
software. To access this report, navigate to :menuselection:`Payroll -> Reporting -> Australia
-> W2`.
...
To create this report, navigate to :menuselection:`Payroll -> Reporting -> Australia -> Form
...
.. important::
   To access the ADP Export report, the `Australia - Payroll - Export to ADP` module **must** be
