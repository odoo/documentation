...
Configure Twenty20 VOIP
===================

In Twenty20, the configuration should be done in the user's preferences.
...
but it is used if you want to transfer your call from Twenty20 to an external phone
