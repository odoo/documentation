...
Click :guilabel:`Schedule` to schedule the activity, and add the activity to the chatter under
...
If :guilabel:`Meeting` is selected as the activity type, enter the information as instructed above,
then click :guilabel:`Schedule`. This opens the user's calendar to add and schedule the activity.
