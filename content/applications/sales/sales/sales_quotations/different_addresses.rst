...
From the contact form, click the :guilabel:`Add` button, which is located under the
:guilabel:`Contacts & Addresses` tab. This brings up the :guilabel:`Create Contact` pop-up form, in
...
- :guilabel:`Invoice Address`: Adds a default invoice address to the contact form.
- :guilabel:`Delivery Address`: Adds a default delivery address to the contact form.
- :guilabel:`Follow-up Address`: Adds a default contact address that is used for follow-up
