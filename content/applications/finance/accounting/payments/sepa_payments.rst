...
Once an ISO 20022 payment method has been added, the :guilabel:`Credit Transfer` section allows you
to select the :guilabel:`ISO 20022 Charge Bearer` type to define who pays for the charging fees, and
the :guilabel:`Default Priority` to define the default processing time for ISO 20022 payments.
