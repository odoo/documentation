...
Group payments allow combining outgoing and incoming payments from the same partner into a single
...
Batch payments allow grouping payments from multiple partners to ease
