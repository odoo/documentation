...
on the capped amount. This ensures compliance with SSC requirements and reflects accurately on the
employee's payslip.
...
- :guilabel:`Automated Calculations`: Contributions are automatically calculated and included in
  payroll, reducing errors and administrative workload.
...
- :guilabel:`Automated Deductions`: Ensures smooth payroll workflows with accurate and timely
