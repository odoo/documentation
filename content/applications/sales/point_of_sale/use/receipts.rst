...
- Enable :guilabel:`Automatic Receipt Printing` to print receipts automatically upon payment
  confirmation.
- Enable :guilabel:`Gift Receipt` to generate receipts that do not display product prices.
...
.. note::
   ...
   :guilabel:`Automatic Receipt Printing` setting must be enabled.
...
#. Select the desired order and click :icon:`fa-print` :guilabel:`Receipt`.
#. Click :icon:`fa-print` :guilabel:`Full Receipt` or :icon:`fa-file-text-o` :guilabel:`Simplified
   Receipt` to determine the type of receipt to print.
...
.. note::
   ...
   - If a receipt printer is not configured, clicking :icon:`fa-print` :guilabel:`Print` on the
     payment confirmation screen, then :icon:`fa-print` :guilabel:`Full Receipt` or
     :icon:`fa-file-text-o` :guilabel:`Simplified Receipt`, triggers the browser's print function.
