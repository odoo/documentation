...
To track stock for POS products, set the :ref:`product type <inventory/type/good-or-services>` to
:guilabel:`Goods` or :guilabel:`Combo` and select a :ref:`tracking option
<inventory/product_management/tracking-inventory>`. Products can be tracked by quantity, :ref:`by
lot, or by serial number <pos/products/sn>`.
