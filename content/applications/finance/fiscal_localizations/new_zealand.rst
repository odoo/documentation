...
.. seealso::
   :doc:`Tax documentation <../../../applications/finance/accounting/taxes>`
...
:menuselection:`Accounting --> Configurations --> Tax Groups`.
...
.. tip::
   Activate :doc:`Developer mode (debug mode) <../../../applications/general/developer_mode>`
   to set up the :guilabel:`Tax Groups`.
