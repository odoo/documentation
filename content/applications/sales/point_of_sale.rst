...
<pos/settings>` to meet your specific business requirements.
...
.. image:: point_of_sale/select-pos-dropdown.png
...
<pos/settings>` and choose the specific categories to display in the :guilabel:`Restrict Categories`
field within the :guilabel:`Product & PoS categories` section.
...
To set up POS receipts, navigate to the :ref:`POS settings <pos/settings>` and scroll down
