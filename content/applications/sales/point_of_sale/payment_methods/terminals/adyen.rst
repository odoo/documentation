...
<pos/terminals/configuration>`. Then, configure the Adyen-specific settings in the :guilabel:`Adyen`
tab on the payment method form:
...
.. tip::
   ...
   - Orders processed through an Adyen terminal can also be :ref:`refunded
     <pos/use/refund-order-based>` using the Adyen :doc:`payment method <../../payment_methods>`.
