...
When handling billable projects, it is essential to understand whether your projects are turning a
profit. Measuring **project profitability** involves keeping track of the costs of resources used to
handle the project, such as employee costs, materials used, purchases, expenses, or after-sales
services. Those resources are then compared with the project revenues to ensure you’re not working
at a loss.

Project profitability is tracked by default in the :doc:`project dashboard <project_dashboard>` on
all billable projects.

Project profitability dashboard
===============================

To access the :doc:`project dashboard <project_dashboard>`, open the **Project** app, and
hover over the desired project’s card. Then, click the :icon:`fa-ellipsis-v`
(:guilabel:`vertical ellipsis`) icon and select :guilabel:`Dashboard`. Alternatively, you can access
the project dashboard from the project’s :ref:`top bar <project/project-management/top-bar>`.
...
displayed in both sections: e.g., the same timesheet is listed in revenues with the amount the
customer paid for the work and in costs with the amount of wages paid to the employees.
...
-----
 ...
 - :guilabel:`Timesheets`: total cost of time tracked by employees via :doc:`timesheets
   </applications/services/timesheets>`, based on the employee's :ref:`employees/hr-settings`.
 ...
 - :guilabel:`Materials`: total cost of products included in
   ...
   :menuselection:`Inventory --> Configuration --> Operations Types` for applicable operations.
