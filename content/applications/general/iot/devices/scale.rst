...
To configure the Ariva S scale for IoT system recognition, refer to the `Mettler's Setup Guide for
Ariva S series scales <https://www.mt.com/dam/RET_DOCS/Ariv.pdf>`_ and follow these steps:
...
#. Reboot the :doc:`IoT box <../iot_box>` or :ref:`restart the Windows virtual IoT service
