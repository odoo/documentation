...
Odoo allows you to write content in various areas across different apps. Whether it's in the
...
To edit a paragraph, select it or double-click on it to display the text editor, and apply any of
...
- :icon:`fa-commenting-o` :guilabel:`Comment`: Add a comment to the selected text.
   ...
   .. tab:: Navigation
      ...
      .. list-table::
         ...
         * - :guilabel:`Table Of Content`
           - Highlight the structure (headings) of this field.
         * - :guilabel:`Viedo Link`
           - Insert a Video.
