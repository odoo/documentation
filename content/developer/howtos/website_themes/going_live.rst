...
.. _howtos/website_themes/going_live/module_import:

Module import
=============

.. _howtos/website_themes/going_live/module_import/saas:
...
.. todo:: Add the ref when the other PR is merged (howtos/website_themes/pages/theme_pages/noupdate).

.. important::
   - Don't forget to untick :guilabel:`Force init` if you import a module for the second time.
     Otherwise, existing data might be lost. (Related to noupdate=1).
...
.. _howtos/website_themes/going_live/module_import/sh:
...
.. _howtos/website_themes/going_live/whats_next:
