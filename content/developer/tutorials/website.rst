...
.. image:: website/airproof-home.png
   :alt: Airproof homepage.
   :align: center

| In the :file:`README` of this `Airproof module <{GITHUB_PATH}>`_, you can find the various
  Airproof designs that you will replicate throughout the different exercises of this tutorial.
...
.. toctree::
    ...
    website/01_theming
    website/02_build_website
    website/03_customisation_part1
    website/04_customisation_part2
    website/05_dynamic_templates
    website/06_going_live