...
.. note::
   ...
   .. warning::
      ...
      will also invalidate the existing keys which cannot be used any more. As a result, new
...
#. Enter a :guilabel:`Name`, leave the :guilabel:`Password (optional)` field empty, as the Plausible
   analytics dashboard integration in Odoo does not support it, then click
   :guilabel:`Create shared link`.
