...
The :guilabel:`Dynamic Content`, such as :ref:`Form <building_blocks/form>`,
...
You can also choose some :guilabel:`tags` or show :guilabel:`variants` if you provide any for your
products. Several :guilabel:`template` options allow you to display your products as you like.
...
.. image:: building_blocks/embed-code.png
   :alt: Embed code block options

.. image:: building_blocks/embed-code-pop-up.png
   :alt: Add the link to the embedded code you want to point to

.. warning::
   Do not copy/paste code you do not understand, this could put your data at risk.
