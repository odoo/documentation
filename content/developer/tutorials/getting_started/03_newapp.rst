...
Our new module will cover a business area that is very specific and therefore not included in the
...
The top area of the form view summarizes important information about the property, such as the name,
...
The Odoo framework will ensure that these modules are installed before our module is installed. Moreover, if
