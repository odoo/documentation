...
.. example::
   For example, take two invoices, one dated 5 March and the other dated 28 March. Both using
   the same payment terms with a single :guilabel:`Due Terms` line for 100% of the due amount, due
   `5` :guilabel:`Days end of the month on the` `1`.
