...
.. seealso::
   Documentation on :ref:`translations <ANCOR website_themes/translations/export>` and
   :doc:`translating modules <../../howtos/translations>` for more details.

.. spoiler:: Solutions

   Find the solution in our Airproof example on `i18n/website_airproof.pot <{GITHUB_PATH}>`_ and
   `i18n/fr_BE.po <{GITHUB_PATH}>`_.
