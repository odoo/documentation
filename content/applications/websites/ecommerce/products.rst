...
To customize the **product page** from the backend, navigate to :menuselection:`Website -->
...
You can also add an additional ecommerce description for marketing purposes that will only
appear on the ecommerce product page under the product name. To do so, go to the :guilabel:`Sales`
tab, scroll down to the :guilabel:`Ecommerce description` section, and add a description. Use Odoo's
:doc:`rich-text editor <../../essentials/html_editor>` features to personalize your content. You
can also insert building blocks from the
:ref:`frontend <ecommerce/products/frontend-customization>`.

.. tip::
   Click the :guilabel:`Go to Website` smart button to return to the frontend product's page.

.. _ecommerce/products/frontend-customization:

Frontend
--------

To customize the **product page** on the frontend, go to the :guilabel:`Shop` and click on the
