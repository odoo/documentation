...
Once the credit note is created, the amount can be modified before validating. Make sure the correct
:guilabel:`Customer`, :guilabel:`Journal`, and :guilabel:`Document Type` are specified, and
the products listed on the :guilabel:`Invoice Lines` tab are configured with the correct taxes.
