...
.. image:: install/error_message_sub_code.png
   :align: center
...
* Do you have the updated version of Odoo 9?
  ...
  * If it's not the case, you may have multiple databases sharing the same
    ...
    .. image:: install/unlink_db_name_collision.png
       :align: center
...
.. image:: install/add_more_users.png
   :align: center
...
.. image:: install/database_expired.png
   :align: center
...
.. toctree::
   ...
   install/geo_ip
   install/community_to_enterprise
