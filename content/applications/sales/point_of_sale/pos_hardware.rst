...
navigate to the :ref:`POS settings <pos/configuration/settings>` and scroll down to the
...
#. Navigate to the :ref:`POS settings <pos/configuration/settings>`.
...
#. Return to the :ref:`POS settings <pos/configuration/settings>` and select an IoT-connected screen
...
#. :ref:`Access the POS settings <pos/configuration/settings>`.
