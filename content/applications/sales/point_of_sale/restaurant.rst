...
.. important::
   ...
   :guilabel:`Point of Sale` section must be enabled in the :ref:`POS settings <pos/settings>`.

.. note::
   When :guilabel:`Booking` is enabled in the :ref:`POS settings <pos/settings>`, a :ref:`Booking
   <pos/restaurant/floors/booking>` button appears on the main interface for viewing and managing
   bookings.
...
To define the point of sale's default start screen, go to the :ref:`POS settings <pos/settings>`,
scroll down to the :guilabel:`PoS Interface` section, and set the :guilabel:`Default Screen` setting
to :guilabel:`Tables` (i.e., :ref:`Floor plan <pos/restaurant/floors>` view) or :ref:`Register
...
.. tip::
   ...
   :ref:`POS settings <pos/settings>`. Under :guilabel:`Floors & Tables Map`, type the floor name in
...
#. Go to the :ref:`POS settings <pos/settings>`, scroll down to the :guilabel:`PoS Interface`
...
To use preconfigured presets, go to the :ref:`POS settings <pos/settings>` and enable the
...
<configuration/epos_printers>` to Odoo, go to the :ref:`POS settings <pos/settings>`, and follow
these steps:
...
#. Define the product categories to be printed by clicking :guilabel:`Add a line` in the
   ...
   popover.
#. Click :guilabel:`Save`.
#. In the :ref:`POS settings <pos/settings>`, click :guilabel:`Save`.
...
.. tip::
   - To access all preparation printers from the :ref:`POS settings <pos/settings>`, scroll down to
     the :guilabel:`Preparation` section and click :icon:`oi-arrow-right` :guilabel:`Printers`.
...
To allow tipping in a POS, go to the :ref:`POS settings <pos/settings>`, scroll down to the
...
tip after payment` setting is enabled in the :ref:`POS settings <pos/settings>`. To process tips
