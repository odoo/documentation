...
- :doc:`sign a document <sign/sign_received_documents>` directly in the Sign app, from a record's
  chatter, or from the Documents app
...
- define :ref:`advanced configuration for signers <sign/prepare-document/signer-settings>` to
  require authentication, allow delegation, or, for templates, assign a fixed signer
