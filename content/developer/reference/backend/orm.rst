...
A :class:`~odoo.api.Domain` is a first-order logical expression used for
...
The :class:`~odoo.api.Domain` can be used as a builder for domains.
...
.. automethod:: odoo.api.Domain.iter_conditions

.. automethod:: odoo.api.Domain.map_conditions
