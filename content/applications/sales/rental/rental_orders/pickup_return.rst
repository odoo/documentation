...
:doc:`../configure_products/product_types` page for more information on *Goods* and *Services*.
...
:ref:`materials <planning/materials>` and :ref:`roles <planning/roles>` in the **Planning** app
...
roles <planning/employees>` in the **Planning** app before creating the product.
...
products in the eCommerce store, refer to the :ref:`Configure pickup and return availability for
eCommerce products <rental/pickup_return/ecommerce-products>` section.
...
The Rental app supports eCommerce configuration at a app and product level when the **Website** app
and the **eCommerce** module are installed. Using the *Unavailability days* setting restricts the
days the rental website allows pickup and returns to be scheduled. To configure the rental product
page in the online store, refer to the :ref:`Product configuration
