...
adjust)` icon at the end of the *Components* tab. Select the following features to enable these
columns:
...
opens to verify that multiple components are to be updated. Click :guilabel:`Update` to verify the
changes.
...
.. _manufacturing/bill_configuration/bom-overview:
