...
:guilabel:`Replenish` button. When replenishing, the purchase |UOM| can be edited if needed.
...
.. seealso::
   :doc:`../../warehouses_storage/replenishment`
...
:ref:`customer display <pos/display>` may become cluttered.
...
#. Open the :ref:`Units of Measure Categories <inventory/uom/categories>` page.
#. Select a unit of measure category.
#. Enable the :guilabel:`Group Products in POS` checkbox.
