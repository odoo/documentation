...
To create a nested article, hover over an article and click the :icon:`fa-plus` :guilabel:`(plus)`
icon.
...
Article items are active building blocks within an article, letting you add and manage specific
types of organized content. They provide different ways to view and manage various kinds of data.

When article items are part of a larger, parent article, they can also show :ref:`properties
<knowledge/articles_editing/properties>`. These are shared data fields from the parent, ensuring
consistent information across all related items and articles.
