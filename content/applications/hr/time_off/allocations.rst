...
.. example::
   ...
   The time off officer creates multiple allocations, and cinfigures the :ref:`Multiple Requests
   form <time_off/allocation-form>` as follows:

   The name for the allocaiton is :guilabel:`Vacation Day - Raffle Prize - 2025 Picnic`. The
