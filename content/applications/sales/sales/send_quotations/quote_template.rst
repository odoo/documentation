...
In Odoo's **Sales** app, salespeople can create reusable quotation templates for common products or
services their business offers.
...
pre-configured email template to be sent to customers upon confirmation of an order.
...
the table, tick the checkboxes for the quotations you wish to cancel.
