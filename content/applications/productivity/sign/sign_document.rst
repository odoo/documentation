...
#. Click on each field to enter the requested information, or, to be guided through the fields in
   ...
   .. note::
      ...
      - When completing an :guilabel:`Initial` or :guilabel:`Signature` field, you need to
...
#. When all required fields have been completed click :guilabel:`Validate & Send Completed
   ...
   enter the requested information for the next and any subsequent documents. Once all documents
   have been signed, click :guilabel:`Validate & Send Completed Document`.
...
'Adopt' initials and signature
------------------------------

If you are an:

- **internal user**, the first time you use Odoo Sign to complete an :guilabel:`Initial` or
  :guilabel:`Signature` field, you need to 'adopt' your initials or signature. Thereafter, your
  intials/signature are stored for future use.

- **external user**, you need to adopt your initials/signature the first time you complete such a
  field in a document or document envelope prepared using Odoo Sign.

To adopt your initials/signature after clicking the relevant field in a document:
