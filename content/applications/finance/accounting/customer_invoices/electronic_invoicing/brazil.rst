...
forth by the :abbr:`SEFAZ (Secretaria da Fazenda)`.
...
- :abbr:`NF-e (Nota Fiscal Eletrônica)`: A mandatory e-invoice for goods and services used in
  B2B and :abbr:`B2G (business-to-government)` transactions.
- :abbr:`CT-e (Conhecimento de Transporte Eletrônico)`: Specific to freight and logistics services.
- :abbr:`NF-e (Nota Fiscal Eletrônica)`: Issued for service-based transactions, with
...
- **Supported formats**: Odoo supports Brazil's authorized e-invoice formats, including :abbr:`NF-e
  ...
  Fazenda)`, :abbr:`NF-e (Nota Fiscal Eletrônica)` customizable for municipal requirements,
  :abbr:`CT-e (Conhecimento de Transporte Eletrônico)` for logistics and transportation, and digital
  PDF invoices with  :abbr:`SEFAZ (Secretaria da Fazenda)` authorization codes and QR codes.
...
.. admonition:: Disclaimer
   ...
   familiar with Brazilian e-invoicing regulations to ensure full compliance tailored to your
