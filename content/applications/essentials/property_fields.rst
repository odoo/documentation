...
.. admonition:: Property vs. regular fields
   ...
   the database. They also rely on a parent-child relationship, applying only to a specific context.
...
Add property fields to a :ref:`form view <studio/views/general/form>`, depending on the influence
of the field levels below.
  ...
  .. list-table::
        ...
        * - :guilabel:`Accounting`
          ...
          - Asset model
            ...
            Journal
        * - :guilabel:`Appraisal`
          - :ref:`Appraisals <appraisals/configuration>`
          - Department
        * - :guilabel:`CRM`
          - :doc:`Pipeline </applications/sales/crm/acquire_leads/email_manual>`
          - Sales team
        * - :guilabel:`Employee`
          - :ref:`Employees <employees/general-info>`
          - Company
        * - :guilabel:`Events`
          - :doc:`Attendees </applications/marketing/events/registration_desk>`
          - Event
        * - :guilabel:`Fleet`
          - :doc:`Vehicles </applications/hr/fleet/new_vehicle>`
          - Vehicle model
        * - :guilabel:`Frontdesk`
          - :ref:`Visitors <frontdesk/list>`
          - Station
        * - :guilabel:`Helpdesk`
          - :ref:`Tickets <helpdesk/follow>`
          - Helpdesk team
        * - :guilabel:`Inventory`
          - :ref:`Lot/Serial number <inventory/product_management/edit-lot>`

            Transfers

            :ref:`Batch transfers <inventory/misc/batch_picking>`
          - Product variants
            ...
            Operation type
        * - :guilabel:`Knowledge`
          - :ref:`Nested article <knowledge/articles_editing/create-article>`
          - Parent article
        * - :guilabel:`Maintenance`
          - :ref:`Equipment <maintenance/equipment_management/add_new_equipment>`
          - Equipment category
        * - :guilabel:`Meeting Rooms`
          - Room
          - Office
        * - :guilabel:`Planning`
          - :ref:`My Planning <planning/roles>`
          - Role
        * - :guilabel:`Project` / :guilabel:`Field Service`
          - :ref:`Tasks <task_creation/task-configuration>`
          - Project
        * - :guilabel:`Recruitment`
          - :ref:`Candidates <recruitment/quick-add-applicant>`

            :ref:`Job positions <recruitment/new_job_position/edit>`
          - Job position

            Company
        * - :guilabel:`Repairs`
          - :ref:`Repair orders <repairs/repair_orders/repair>`
          - Company
        * - :guilabel:`Sales`
          - Products
          - Category
