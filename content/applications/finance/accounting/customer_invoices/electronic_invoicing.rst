...
#. Documents can either be received in a purchase journal or via the :doc:`Documents app
   ...
   - :ref:`Receive in Documents <accounting/e-invoicing/receive-vendor-bills-documents-app>`: Select
     a folder name in the :guilabel:`Document Workspace` field if multiple purchase journals are
     used.
...
New documents received via Peppol are checked multiple times a day. Following the
...
Vendor bills received in Documents
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
