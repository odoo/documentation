...
This feature adds the following document types: 23, 24, 25, 26, 27, 28, 33, 43, 45, 46, 48, 58, 60,
61, 150, 151, 157, 158, 161, 162, 164, 166, 167, 171, 172, 180, 182, 186, 188, 332.
...
To activate them, navigate to :menuselection:`Accounting --> Configuration --> AFIP: Document Types`
and remove any active filters. Then, find the documents and activate them by toggling the option
:guilabel:`Active`.
