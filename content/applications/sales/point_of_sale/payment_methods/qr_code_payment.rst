...
Once the payment method is created, go to the :ref:`POS' settings <pos/configuration/settings>` and
add the payment method to your POS under the :guilabel:`Payment` section.
