...
- **Supported formats**: Odoo supports the Factur-X hybrid format (PDF with embedded XML) required
  for compliance with French e-invoicing standards. It is also compatible with :abbr:`UBL (Universal Business Language)`
  XML for transactions via the Peppol network, facilitating both local and international invoicing.
  Odoo enables businesses, through Chorus Pro France’s official e-invoicing platform, to submit
  compliant e-invoices directly to public authorities and soon to private sector recipients as B2B
...
.. seealso::
   :doc:`../../../fiscal_localizations/france`
