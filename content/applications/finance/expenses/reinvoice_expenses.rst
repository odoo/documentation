...
.. important::
   ...
   Approving expenses, posting expenses to accounting, and re-invoicing expenses on :abbr:`SOs
   (Sales Orders)` are **only** possible for users with the appropriate :doc:`access rights
...
:menuselection:`Expenses app --> Configuration --> Expense Categories`. Click on the desired expense
category or :doc:`create a new one <expense_categories>`.

Under the :guilabel:`Invoicing` section, click the radio button next to the desired selection for
:guilabel:`Re-Invoice Costs`:
...
+======================================================================================================+=============================================================================+===================================================+
| :guilabel:`COMM`\: Communication expenses such as phone bills, postage, etc.                         | :guilabel:`FOOD`\: Meal expenses such as restaurants, business lunches, etc | :guilabel:`EXP_GEN`\: Others.                     |
+------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------+---------------------------------------------------+
| :guilabel:`TRANS & ACCT`\: Travel and accommodation expenses such as hotel, plane ticket, taxi, etc. | :guilabel:`MIL`\: Mileage.                                                  | :guilabel:`GIFT`\: Gifts to customers or vendors. |
+------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------+---------------------------------------------------+
...
As an optional step, select the :guilabel:`Analytic Distribution` the expense is posted to. Multiple
accounts can be selected, if desired.

.. image:: reinvoice_expenses/sample-expense-form-gas.png
...
.. seealso::
   :doc:`Detailed instructions to create and submit an expense report <expense_reports>`
...
To email the invoice to the customer, click :guilabel:`Send`. A :guilabel:`Print & Send` pop-up
...
Click :guilabel:`Send` to email the invoice to the customer. The pop-up window disappears, and a PDF
...
Navigate to the invoice by clicking :menuselection:`Expenses app --> Expense Reports` and select the
...
After clicking :guilabel:`Send`, the invoice is emailed to the customer and published online on the
customer portal. Click :guilabel:`Preview` to see the customer's view of the invoice and payment
methods.
