...
#. *Sales order*: Created automatically when the customer accepts the quotation, confirming the sale.
...
- CRM: :doc:`Convert opportunities <../crm/acquire_leads/send_quotes>` into quotes to follow up on
  potential deals.
- Helpdesk: :doc:`Generate quotes from tickets <../../services/helpdesk/advanced/after_sales>` when
...
.. image:: sales_quotations/sales_quotation.png
