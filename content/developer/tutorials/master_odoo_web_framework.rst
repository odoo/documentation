...
:doc:`Introduction to Odoo JS Framework tutorial <discover_js_framework>` and are looking
to deepen their knowledge of the Odoo web framework.
...
fields and views, notifications, command palette, and much more. This tutorial will provide you
with the knowledge and skills you need to take full advantage of the Odoo web framework. So, let's
get started!
...
- Start a new Odoo database and install the modules `awesome_tshirt`, and
  `awesome_gallery`.
