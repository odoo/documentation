...
.. note::
   ...
   connecting the scale. To enable the connection, open the Linux terminal, type `666/dev/` followed
   by the scale port number, press `ENTER`, then enter the computer password.
