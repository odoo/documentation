...
Add property fields to a :ref:`form view <studio/views/general/form>` (Model). The system shares
these fields with all records that have the same parent.
  ...
  .. list-table::
        ...
        * - :guilabel:`Inventory`
          ...
          - :ref:`Product variants <product-variants/add-product-variants>`
