...
.. tip::
  Another way to select all expenses with a :guilabel:`Draft` status is to click into the search bar
  and select :guilabel:`To Submit` in the :icon:`fa-filter` :guilabel:`Filters` column, then click
  the checkbox next to :guilabel:`Employee`.
