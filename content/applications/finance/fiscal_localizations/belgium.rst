...
**CodaBox** is a service that allows Belgian companies and accounting firms to access to bank
...
.. tabs::
   ...
   .. tab:: For Companies
      ...
      .. important::
         ...
         :guilabel:`Belgium`, the :guilabel:`Tax ID` or :guilabel:`Company ID` field is filled.
   ...
   .. tab:: For Accounting Firms
      ...
      .. important::
         Make sure the company settings are correctly configured, i.e., the country is set to
         :guilabel:`Belgium`, the :guilabel:`Tax ID` or :guilabel:`Company ID` and
         :guilabel:`Accounting Firm` fields are filled, as well as the :guilabel:`Tax ID` of the
         :guilabel:`Accounting Firm`.
