...
If a device is legitimate and should be stored in the database, click :guilabel:`Save`. If the
device should be removed from the list of devices, but is *not* a security threat (is a legitimate
login), click :guilabel:`Delete`.
