...
To view the *Inventory Adjustments* page, navigate to :menuselection:`Inventory app -->
...
- :guilabel:`Favorites`: adds a clickable star icon next to each product. Adding a favorite will
...
to verify and update product :guilabel:`Count Quantities`, as it's necessary to do so.
