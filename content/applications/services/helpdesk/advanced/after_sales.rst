...
.. note::
  ...
  Coupon programs can also be created in the **Point of Sale** application or **Website**
  application. Refer to :doc:`discount and loyalty programs
...
incoming returned products. Click :guilabel:`Return for Exchange` to create an exchange transfer.
