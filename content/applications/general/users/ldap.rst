...
.. note::
    When using Microsoft Active Directory (AD) for LDAP authentication in Odoo, users may experience
    login issues despite using valid credentials. To resolve this, create a new system parameter to
    disable referral chasing in the LDAP client:
