...
Set up manual or automatic :ref:`currency rate <multi-currency/config-rates>` updates and define the
accounts and journals used to record gains or losses incurred on :ref:`exchange rate differences
...
To a bank account in a foreign currency, first create a new bank journal via
...
and allows  an exchange rate to be set manually or entries to be adjusted. To access the report, go
to :menuselection:`Accounting --> Review --> Unrealized Currencies`.
