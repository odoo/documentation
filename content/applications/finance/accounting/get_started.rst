...
- For invoices and credit notes, go to :menuselection:`Accounting --> Customers --> Invoices`, click
  the :icon:`fa-cog` (:guilabel:`Actions`) icon, and click :icon:`oi-download` :guilabel:`Import`.
  Click :icon:`oi-download` :guilabel:`Template for Invoices` to download the template.
- For vendor bills and refunds, go to :menuselection:`Accounting --> Vendors --> Bills`, click the
  :icon:`fa-cog` (:guilabel:`Actions`) icon, and click :icon:`oi-download` :guilabel:`Import`. Click
  :icon:`oi-download` :guilabel:`Template for Bills` to download the template.
...
:icon:`fa-cog` (:guilabel:`Actions`) icon, and click :icon:`oi-download` :guilabel:`Import`. Click
:icon:`oi-download` :guilabel:`Template for Inventory Adjustments` to download the template.
...
(:guilabel:`Actions`) icon, and click :icon:`oi-download` :guilabel:`Import`. Click
:icon:`oi-download` :guilabel:`Template for Misc. Operations` to download the template.
