...
You can enable the :guilabel:`Buy Now` button to take customers directly to the
...
To enable it, go to :menuselection:`Website --> Configuration --> Settings`, scroll to the
:guilabel:`Shop—Checkout Process` section, tick :guilabel:`Buy Now`, and :guilabel:`Save`.
