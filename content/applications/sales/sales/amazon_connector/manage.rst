...
.. important::
   Before switching an Amazon listing from :abbr:`FBM (Fulfilled By Merchant)` to
   :abbr:`FBA (Fulfilled By Amazon)`, it's important to first clear out the existing FBM inventory.
   This is crucial to avoid future FBM orders from being generated by Amazon.
