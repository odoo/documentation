...
#. If a :ref:`default invoice layout <studio/pdf-reports/default-layout>` hasn't been customized, a
   :guilabel:`Configure your document layout` pop-up window appears. Configure the invoice layout
   and click :guilabel:`Continue`.
...
#. In the :guilabel:`Print & Send` window:
   ...
   - If a preferred :guilabel:`Invoice sending` method was set in the contact form, it is selected
     by default. A different sending option can be chosen if needed.
