...
You will find `images here <{GITHUB_TUTO_PATH}/website_airproof/static/src/img/content>`_ and the
`icons here <{GITHUB_TUTO_PATH}/website_airproof/static/src/img/content/icons>`_.
...
.. tip::
   ...
   - Create the different products via the backend. You will find some `product pictures here
