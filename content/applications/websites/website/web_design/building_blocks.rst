...
￼
Form
The Form block is used to collect information from website visitors and create records in your database, if applicable. To add a form to a website page, drag and drop the Contact & Forms category, then select the Form block.
...
or a Job` (:doc:`Recruitment </applications/hr/recruitment>`)
