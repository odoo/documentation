...
:icon:`fa-ellipsis-v` icon on one of your projects, and click on :guilabel:`Settings`. Click on the
:guilabel:`Settings` tab, look for :guilabel:`Tasks Management` and make sure :guilabel:`Milestones`
is enabled.
