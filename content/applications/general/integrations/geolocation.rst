...
- Validate addresses with the :ref:`Avalara address validation
  <accounting/avalara/address-validation>` feature.
...
technicians </applications/services/planning/field_service>` and delivery routes to drivers in a
:doc:`dispatch management system
...
#. Under :guilabel:`Mapbox`, paste the Mapbox access token into the :guilabel:`Token` field.
#. Click :guilabel:`Save`.
