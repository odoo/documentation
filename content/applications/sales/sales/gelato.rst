...
.. important::
   The company information (Company Name and Billing address) in the Gelato account *must* match the
   company information in the Odoo database in order for sales orders to be confirmed and sent to
...
.. important::
   Copy the API key and store on a notepad before leaving this page. Once the page is refreshed or
   exited, the key will not be available to copy.
