...
``feature_result`` for the ``bank_statement_lines`` feature
***********************************************************

It is returned as a list of dictionaries where each dictionary represents a bank statement line.
Each value follows a :ref:`latestextract_api/get_result/feature_result` structure.

.. code-block:: js

    "bank_statement_lines": [
        {
            "amount": feature_result,
            "description": feature_result,
            "date": feature_result,
        },
        ...
