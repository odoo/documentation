...
.. image:: support_calls/call-queue-login.png
   :alt: The Odoo VoIP widget with an agent's login code entered.
...
.. image:: support_calls/voip-widget-call.png
   :alt: The VoIP widget opened to a call, showing the shortcut icons a support agent has access to.
...
.. image:: support_calls/call-queue-logout.png
   :alt: The Odoo VoIP widget with an agent's logout code entered.
