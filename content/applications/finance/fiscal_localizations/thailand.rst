...
The Thai localization utilizes specific fields :doc:`/applications/essentials/contacts` to generate
Revenue Department reports and files used for submission.
...
:guilabel:`Print`, then select :guilabel:`Commercial Invoice`.
