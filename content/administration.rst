...
- :doc:`Packaged installers <administration/install/packages>` are suitable for testing Odoo and developing
  modules. They can be used for long-term production with additional deployment and maintenance
  work.

- :doc:`Source install <administration/install/source>` provides greater flexibility, as it allows, for example,
...
.. tip::
   :doc:`Switch from Community to Enterprise <administration/install/community_to_enterprise>` at
