...
.. important::
   ...
   However, for products that cost less than the 50% down payment, the down payments are not able to
   be deducted when it comes time to invoice the customer.
...
.. important::
   ...
   available on the draft invoice. Please note, the income account on posted down payments **can't**
   be modified.
