...
`Superintendencia Nacional de Aduanas y de Administración Tributaria (SUNAT) <https://www.sunat.gob.pe/>`_.
...
- **Comprobante de Pago Electrónico (CPE)**: A mandatory electronic document required for B2B, B2C,
  and B2G transactions, fully compliant with :abbr:`SUNAT (Superintendencia Nacional de Aduanas y de
  Administración Tributaria)`’s technical specifications.
...
.. admonition:: Disclaimer
   ...
   with a tax advisor or legal professional familiar with Peru’s e-invoicing laws to ensure full
   compliance tailored to your business needs.
