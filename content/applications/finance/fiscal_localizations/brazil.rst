...
.. important::
   For service taxes created manually, NFS-e can't be issued. To :ref:`electronically send an NFS-e
...
(IAPs) <../../essentials/in_app_purchase>` to compute taxes and handle electronic documents (e.g.,
:ref:`NF-e <localizations/brazil/e-invoice-goods>`, :ref:`NFS-e
<localizations/brazil/e-invoice-services>`). Each action consumes credits from the `IAP credit
balance <https://iap.odoo.com/iap/in-app-services/819>`_.
...
- :ref:`Create an account in AvaTax <localizations/brazil/avatax-credentials>`.
...
section, add the administration Email address for the AvaTax portal in the :guilabel:`AvaTax Portal
...
.. tip::
   ...
   service, :ref:`access to AvaTax <localizations/brazil/avatax-credentials>` is needed and the
   :ref:`certificate must be uploaded <localizations/brazil/certificate-upload>`.
