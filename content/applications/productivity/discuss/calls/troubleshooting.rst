...
.. note::
   Critical errors are always logged, even without RTC logging enabled. The logging option
...
each participant. This is particularly useful for examining participants with connection issues.
...
1. Hover over a participant video
...
You can send upload these longs in an issue ticket or analyze them with the
