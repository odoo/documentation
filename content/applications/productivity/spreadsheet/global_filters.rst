...
#. Optionally, enter a :guilabel:`Default value` of :guilabel:`Is set` or :guilabel:`Is not set`.
#. In the :guilabel:`Field matching` section, for each data source click below the data source name
...
.. example::
   ...
   all opportunities that are active, i.e., for which the :guilabel:`Active` checkbox is enabled on
