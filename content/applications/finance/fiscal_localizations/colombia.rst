...
#. Configure the |DIAN| environment; the |DIAN| electronic invoicing module offers four different
   ...
   - **Production environment**: Activate production databases to generate valid electronic
     documents. To activate it, disable both the :guilabel:`Test environment` and the
