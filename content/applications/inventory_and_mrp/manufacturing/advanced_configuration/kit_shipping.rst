...
:guilabel:`Track Inventory` if inventory tracking is required (i.e., *stored*) or leave it unchecked
if inventory tracking for the kit is not necessary (i.e., *consumed*).
