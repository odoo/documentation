...
Once enabled, you can establish an XBRL connection with the Dutch tax authorities by navigating to
:menuselection:`Reporting --> Tax Return` in the **Accounting** app, clicking the :icon:`fa-cog`
:guilabel:`(gear)` icon, and selecting :guilabel:`XBRL`.
