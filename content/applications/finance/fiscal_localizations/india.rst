...
- TDS entry is automatically reconciled once created.

.. note::
   The default journal for TDS Entry can be configured in
   :menuselection:`Accounting --> Configuration --> Settings --> Default Accounts --> India TDS Control`.
